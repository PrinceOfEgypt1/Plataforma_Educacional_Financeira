...
| **Critério de aceite** | Cabe em 824px sem rolagem; KPIs com os valores do cenário fixo; texto legível (≥14px); nenhum espaço vazio inútil |
...
| **Critério de aceite** | Percentual calculado corretamente (700.000/870.000 = 80,46%); cabe em 824px; texto didático e não técnico |
...
| **Critério de aceite** | Fórmula legível; valores corretos (870.000 − 700.000 = 170.000); cabe em 824px |
...
| **Critério de aceite** | Campos com height 44px; cálculo em tempo real; hint visível; cabe em 824px |
...
| **Critério de aceite** | Derivação da taxa anual correta; cabe em 824px |
...
| **Critério de aceite** | 205 × 120 = 24.600 calculado corretamente; alerta visível; cabe em 824px |
...
| **Componentes** | `FORM` (radio/toggle: SAC — padrão, ou PRICE), `CARD-D` (explicação do sistema selecionado com mini-resumo de vantagens), `CARD-L` (comparação secundária: sempre SAC × PRICE com base justa) |
| **Conteúdo obrigatório** | Seletor de sistema; mini-explicação dinâmica; confirmação de que a comparação usa base justa |
| **Critério de aceite** | SAC selecionado por default; texto dinâmico conforme seleção; cabe em 824px |
...
| **Critério de aceite** | Todos os valores do cenário visíveis; CTA Aurora visível e chamativo; cabe em 824px |
...
| **Critério de aceite** | Valores corretos para SAC 170.000 / 120 meses / 0,85% + 205/mês; card Aurora não sobreposto; cabe em 824px |
...
| **Critério de aceite** | Todos os parâmetros listados; cabe em 824px |
...
| **Critério de aceite** | 3–4 alertas visíveis sem rolagem; linguagem acessível; cabe em 824px |
...
| **Critério de aceite** | Texto legível e educacional; KPI correto; cabe em 824px |
...
| **Critério de aceite** | Valores corretos da 1ª parcela SAC; gráfico legível; cabe em 824px |
...
| **Critério de aceite** | Fórmula legível; 170.000/120 = 1.416,67 correto; cabe em 824px |
...
| **Critério de aceite** | 0,0085 × 170.000 = 1.445,00 correto; cabe em 824px |
...
| **Critério de aceite** | Gráfico com 2 séries (SAC azul, PRICE violeta); saldos nos marcos corretos; cabe em 824px |
...
| **Critério de aceite** | Dois cards lado a lado; totais com valores corretos calculados na mesma base; cabe em 824px |
...
| Atributo | Valor |
|---|---|
| **Objetivo** | Exibir a comparação SAC × PRICE de forma sintética e impactante |
...
| **Critério de aceite** | Base justa confirmada; card Aurora presente; economia calculada corretamente; cabe em 824px |
...
| **Critério de aceite** | Cabeçalho navy/branco; 8 linhas visíveis; paginador funcional; valores corretos; sem scroll vertical; cabe em 824px |
...
| **Critério de aceite** | Mesma taxa, mesmo prazo, mesmo principal que SAC; cabe em 824px |

### Aba 5.4 — Gráfico

| Atributo | Valor |
|---|---|
| **Objetivo** | Visualizar graficamente as diferenças SAC × PRICE |
...
| **Critério de aceite** | Gráfico legível; legenda visível; encargos iguais (base justa); interpretação presente; cabe em 824px |
...
| **Critério de aceite** | Texto educacional; sem jargão excessivo; cabe em 824px |
...
| **Critério de aceite** | Fórmulas legíveis em fonte mono; cálculos conferíveis; cabe em 824px |
...
| **Critério de aceite** | Fórmula HP visível e legível; cabe em 824px |
...
| **Critério de aceite** | Tabela legível; todos os valores corretos; cabe em 824px |
...
| **Critério de aceite** | Passos numerados; fórmulas legíveis; cabe em 824px |
...
| **Componentes** | `CHECKLIST` (verificações: soma das amortizações = principal; saldo final = 0; total de encargos = 24.600; base justa SAC × PRICE confirmada), `CARD-L` (conclusão: cálculos conferidos) |
...
| **Critério de aceite** | Todas as verificações passando; linguagem auditável; cabe em 824px |
...
| **Critério de aceite** | Diagnóstico educacional e não alarmista; KPIs corretos; cabe em 824px |
...
| **Critério de aceite** | Todos os itens visíveis sem rolagem; itens práticos e relevantes; cabe em 824px |
...
| **Critério de aceite** | 4 cards visíveis; texto acionável; cabe em 824px |
...
| **Critério de aceite** | 4 alertas legíveis sem rolagem; cabe em 824px |
...
| **Critério de aceite** | Card Aurora presente e legível; mensagem positiva; CTAs visíveis; cabe em 824px |
